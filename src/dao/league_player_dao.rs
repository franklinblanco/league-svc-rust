...
pub async fn update_league_player_status(conn: &MySqlPool, league_id: i32, player_id: i32, status: &LeaguePlayerStatus) -> Result<MySqlQueryResult, GenericError<sqlx::Error>> {
