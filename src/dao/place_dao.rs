...
pub async fn get_place_with_id(conn: &MySqlPool, place_id: u32) -> Result<Option<Place>, GenericError<sqlx::Error>>{
...
pub async fn get_places_with_country_paged(conn: &MySqlPool, country: String, from_row: u32, to_row: u32) -> Result<Vec<Place>, GenericError<sqlx::Error>>{
...
pub async fn get_place_with_sport_id_paged(conn: &MySqlPool, sport_id: u32, from_row: u32, to_row: u32) -> Result<Vec<Place>, GenericError<sqlx::Error>>{
