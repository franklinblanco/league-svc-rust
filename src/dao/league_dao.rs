...
pub async fn get_leagues_by_in_place_limited_to(conn: &MySqlPool, place_id: i32, from_row: u32, to_row: u32) -> Result<Vec<League>, GenericError<sqlx::Error>>{
...
pub async fn get_leagues_by_player_limited_to(conn: &MySqlPool, player_id: i32, from_row: u32, to_row: u32) -> Result<Vec<League>, GenericError<sqlx::Error>>{
...
pub async fn get_all_leagues_player_has_applied_to(conn: &MySqlPool, player_id: i32, from_row: u32, to_row: u32) -> Result<Vec<League>, GenericError<sqlx::Error>> {
